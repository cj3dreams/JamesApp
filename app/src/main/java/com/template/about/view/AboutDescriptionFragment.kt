...
class AboutDescriptionFragment() : Fragment() {
    ...
    override fun onCreateView(
        ...
        button2.setOnClickListener{
            requireActivity().supportFragmentManager.beginTransaction().apply {
                add(R.id.frag_cont, DescriptionFragment(2)).commit()
            }
        }
        button3 = view.findViewById(R.id.button3)
        button3.setOnClickListener{
            requireActivity().supportFragmentManager.beginTransaction().apply {
                add(R.id.frag_cont, DescriptionFragment(3)).commit()
            }
        }
        button4 = view.findViewById(R.id.button4)
        button4.setOnClickListener{
            requireActivity().supportFragmentManager.beginTransaction().apply {
                add(R.id.frag_cont, DescriptionFragment(4)).commit()
            }
        }
        button5 = view.findViewById(R.id.button5)
        button5.setOnClickListener{
            requireActivity().supportFragmentManager.beginTransaction().apply {
                add(R.id.frag_cont, DescriptionFragment(5)).commit()
            }
        }
        return view
    }
